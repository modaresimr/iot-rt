...
class Wrapper extends Formr
{
	...
	*/
    ...
    public static function bootstrap_css($key = '',$controls='')
    {
        $array = [
            'div' => 'form-group',
            'label' => 'control-label',
    ...
    public function bootstrap($element = '', $data = '')
    {
        ...
        if ($data['type'] == 'checkbox') {
            ...
            if (substr($data['value'], -1) != ']') {
                ...
                $return = $this->instance->_nl(1) . '<div id="_' . $data['id'] . '" class="' . static::bootstrap_css('div',$this->instance->controls) . '">';
            }
        } else {
            $return = $this->instance->_nl(1) . '<div id="_' . $data['id'] . '" class="' . static::bootstrap_css('div',$this->instance->controls);
        }
        ...
        if (($data['type'] == 'checkbox' || $data['type'] == 'radio') &&substr($data['name'], -1) == ']') {
